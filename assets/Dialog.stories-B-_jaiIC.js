import{j as e}from"./jsx-runtime-BO8uF4Og.js";import{O as F,C as A,a as z,R as E,T as S,P as Z,D as I,b as k}from"./index-CQ-IqFoI.js";import{B as n}from"./Button-BwlrdoZf.js";import{s as h}from"./styles-Bqt2ynIu.js";import{a as r}from"./utils-CU3My8Oi.js";import{r as d}from"./index-D4H_InIO.js";import{g as H}from"./z-index-CmEG1ohp.js";import{X as q}from"./x-B9-lGSIk.js";import"./index-DB-GfMvg.js";import"./index-D8GmRN1t.js";import"./index-Ak5Mws-w.js";import"./index-CWZjxdH8.js";import"./index-C1hSi-0V.js";import"./index-bUn38NNn.js";import"./index-vYCkCKEW.js";import"./index-CZyo9ktw.js";import"./index-DAnQV6hb.js";import"./index-Dg2NYmXS.js";import"./index-DLaBReRc.js";import"./useAriaDisabled-DHTVgRPt.js";import"./constants-C4w3S9le.js";import"./index-NE6MC3wq.js";import"./createLucideIcon-CRH11QI6.js";const f=d.forwardRef(({className:o,zIndex:t,...a},l)=>{const D=H("overlay",t);return e.jsx(F,{ref:l,className:r(`fixed inset-0 bg-black/80 data-[state=open]:animate-in data-[state=closed]:animate-out
...
`,O=()=>e.jsxs(x,{children:[e.jsx(W,{asChild:!0,children:e.jsx(n,{variant:"danger",children:"Delete Account"})}),e.jsxs(c,{children:[e.jsxs(g,{children:[e.jsx(u,{children:"Are you sure?"}),e.jsx(m,{children:"This action cannot be undone. This will permanently delete your account and remove your data from our servers."})]}),e.jsxs(p,{children:[e.jsx(n,{children:"Cancel"}),e.jsx(n,{variant:"danger",children:"Delete Account"})]})]})]});O.__docgenInfo={description:"",methods:[],displayName:"DialogWithDestructiveAction"};const V=`import { Button } from '@/components/Button';
import { Dialog, DialogContent, DialogTrigger } from '../src/Dialog';
import { DialogDescription } from '../src/DialogDescription';
import { DialogFooter } from '../src/DialogFooter';
import { DialogHeader } from '../src/DialogHeader';
...
Demonstrates a typical dialog with header, content, and footer sections.`,...(N=(j=i.parameters)==null?void 0:j.docs)==null?void 0:N.description}}};var T,C,w,_,B;s.parameters={...s.parameters,docs:{...(T=s.parameters)==null?void 0:T.docs,source:{originalSource:`{
