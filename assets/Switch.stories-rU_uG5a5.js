import{j as s}from"./jsx-runtime-BO8uF4Og.js";import{r as m}from"./index-D4H_InIO.js";import{S as z}from"./Switch-biii2W__.js";import"./Label-CjB5ZDVY.js";import"./styles-hHSuIYOZ.js";import"./utils-l21BANrb.js";import"./index-C1hSi-0V.js";import"./index-bUn38NNn.js";import"./index-vYCkCKEW.js";import"./index-CZyo9ktw.js";import"./index-D8GmRN1t.js";import"./useAriaDisabled-DHTVgRPt.js";import"./index-DwviEg3j.js";import"./index-DXU_LAI1.js";import"./index-C6Lf2F3X.js";const oe={title:"Inputs & Forms/Switch",component:z,parameters:{},argTypes:{isChecked:{control:"boolean"},isDisabled:{control:"boolean"},onCheckedChange:{action:"checked changed"}},tags:["autodocs"]},c=({isChecked:e=!1,...B})=>{const[d,l]=m.useState(e);return m.useEffect(()=>{l(!!e)},[e]),s.jsxs("div",{className:"space-y-4",children:[s.jsx(z,{...B,isChecked:d,onCheckedChange:()=>l(!d)}),s.jsxs("p",{className:"text-sm text-muted-foreground",children:["Switch ",d?"is on":"is off"]})]})},r={args:{label:"Airplane Mode",id:"airplane-mode"},tags:["!autodocs"]},a={render:e=>s.jsx(c,{...e}),args:{label:"Airplane Mode",id:"airplane-mode"}},t={render:e=>s.jsx(c,{...e}),args:{label:"Notifications",id:"notifications",isChecked:!0}},o={render:e=>s.jsx(c,{...e}),args:{label:"Disabled switch",id:"disabled",isDisabled:!0}},i={render:e=>s.jsx(c,{...e}),args:{label:"Disabled checked switch",id:"disabled-checked",isChecked:!0,isDisabled:!0}},n={render:e=>s.jsx(c,{...e}),args:{label:s.jsxs("div",{className:"flex flex-col",children:[s.jsx("span",{className:"font-bold",children:"Dark Mode"}),s.jsx("span",{className:"text-sm text-muted-foreground",children:"Enable dark mode theme"})]}),id:"dark-mode"}};var p,h,u,g,b;r.parameters={...r.parameters,docs:{...(p=r.parameters)==null?void 0:p.docs,source:{originalSource:`{
  args: {
    label: 'Airplane Mode',
    id: 'airplane-mode'
  },
...
Demonstrates a non-interactive switch that's toggled on.`,...(W=(T=i.parameters)==null?void 0:T.docs)==null?void 0:W.description}}};var _,F,O,U,q;n.parameters={...n.parameters,docs:{...(_=n.parameters)==null?void 0:_.docs,source:{originalSource:`{
  render: args => <SwitchDemo {...args} />,
  args: {
...
}`,...(O=(F=n.parameters)==null?void 0:F.docs)==null?void 0:O.source},description:{story:`A switch with custom label content.
Shows how to use rich content in the switch label.`,...(q=(U=n.parameters)==null?void 0:U.docs)==null?void 0:q.description}}};const ie=["Playground","Default","Checked","Disabled","DisabledChecked","WithCustomLabel"];export{t as Checked,a as Default,o as Disabled,i as DisabledChecked,r as Playground,n as WithCustomLabel,ie as __namedExportsOrder,oe as default};
