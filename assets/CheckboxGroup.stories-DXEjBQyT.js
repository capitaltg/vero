import{j as e}from"./jsx-runtime-DSvmvvsx.js";import{r as s}from"./index-B0WjJBI_.js";import{C as n}from"./CheckboxGroup-DiwTbOnX.js";import"./_commonjsHelpers-CqkleIqs.js";import"./useFormGroupLayout-COYHMi0M.js";import"./utils-CU3My8Oi.js";import"./Checkbox-D8-RNT4n.js";import"./form-controls-UvU-3cIH.js";import"./index-EiwPuDyL.js";import"./index-B5oA2Zbg.js";import"./index-B8vvyUb-.js";import"./index-DBA0bpW4.js";import"./index-BHtEszHx.js";import"./index-CoRj-x2w.js";import"./index-KklXjS-Z.js";import"./index-CwPCC0ZT.js";import"./index-BOrrHd12.js";import"./constants-D9UEAID0.js";import"./styles-CafxXXJc.js";import"./index-NE6MC3wq.js";import"./useAriaDisabled-BVkOu7OW.js";import"./useAriaLabelled-RfpmMyng.js";import"./check-C42IfL-F.js";import"./createLucideIcon-BeEkWZrd.js";import"./Label-BalUMPW8.js";const Ue=[{id:"option1",label:"Option 1"},{id:"option2",label:"Option 2"},{id:"option3",label:"Option 3"}],De=()=>{const[o,t]=s.useState([]);return e.jsxs("div",{className:"space-y-4",children:[e.jsx(n,{options:Ue,orientation:"horizontal",value:o,variant:"button",onChange:t}),e.jsxs("p",{className:"text-sm text-muted-foreground",children:["Selected values: ",o.length>0?o.join(", "):"none"]})]})};De.__docgenInfo={description:"",methods:[],displayName:"CheckboxGroupButton"};const Ae=`import { useState } from 'react';
...
`,Re=[{id:"option1",label:"Option 1"},{id:"option2",label:"Option 2"},{id:"option3",label:"Option 3"}],Te=()=>{const[o,t]=s.useState([]);return e.jsxs("div",{className:"space-y-4",children:[e.jsx(n,{options:Re,orientation:"vertical",value:o,variant:"button",onChange:t}),e.jsxs("p",{className:"text-sm text-muted-foreground",children:["Selected values: ",o.length>0?o.join(", "):"none"]})]})};Te.__docgenInfo={description:"",methods:[],displayName:"CheckboxGroupButtonVertical"};const Le=`import { useState } from 'react';
import { CheckboxGroup } from '../src/CheckboxGroup';
...
Shows a basic vertical checkbox group with no initial selection.`,...(V=(N=r.parameters)==null?void 0:N.docs)==null?void 0:V.description}}};var w,D,T,W,I;p.parameters={...p.parameters,docs:{...(w=p.parameters)==null?void 0:w.docs,source:{originalSource:`{
...
}`,...(T=(D=p.parameters)==null?void 0:D.docs)==null?void 0:T.source},description:{story:`CheckboxGroup with pre-selected values.
...
Shows checkbox options with descriptions below each label.`,...(we=(Ve=v.parameters)==null?void 0:Ve.docs)==null?void 0:we.description}}};const Eo=["Playground","Default","WithSelection","Horizontal","Vertical","Tile","TileWithSelection","Button","ButtonVertical","ButtonWithSelection","SingleColumn","ThreeColumns","WithDescription"];export{m as Button,h as ButtonVertical,g as ButtonWithSelection,r as Default,c as Horizontal,a as Playground,x as SingleColumn,b as ThreeColumns,u as Tile,d as TileWithSelection,l as Vertical,v as WithDescription,p as WithSelection,Eo as __namedExportsOrder,qo as default};
