import{j as t}from"./jsx-runtime-BO8uF4Og.js";import{r as _}from"./index-D4H_InIO.js";import{c as g}from"./utils-CytzSlOG.js";import{P as M,a as O,b as W}from"./Popover-CvV8cXTf.js";import{B as z}from"./Button-CYoANYDv.js";import{C as U,f as l,a as $}from"./Calendar-1OKNMGT7.js";import"./styles-DfGEMFtJ.js";import"./index-DwviEg3j.js";import"./index-BekKX9Q6.js";import"./index-D6t6XU86.js";import"./index-CNI2vRWb.js";import"./index-bUn38NNn.js";import"./index-vYCkCKEW.js";import"./index-DAnQV6hb.js";import"./index-Dg2NYmXS.js";import"./index-DsCZslo7.js";import"./index-CWhMmZjO.js";import"./floating-ui.react-dom-Cto5zZXc.js";import"./index-C6Lf2F3X.js";import"./index-CbP7PoiL.js";import"./index-BwobEAja.js";import"./createLucideIcon-B89bYmoG.js";import"./chevron-right-MP11DFyI.js";const c=_.forwardRef(({value:e,onChange:a,placeholder:r={from:"Pick start date",to:"Pick end date"},className:p},F)=>{const B=o=>{const{from:n,to:I}=e;if(!n)return a({from:o,to:void 0});if(o<n)return a({from:o,to:void 0});if(n&&I)return a({from:o,to:void 0});if(o>n)return a({from:n,to:o});if(o.getTime()===n.getTime())return a({from:void 0,to:void 0})};return t.jsx("div",{className:g("grid gap-2",p),children:t.jsxs(M,{children:[t.jsx(O,{asChild:!0,children:t.jsxs(z,{ref:F,id:"date",variant:"input",className:g("w-full justify-start px-3 text-left font-normal",!e.from&&!e.to&&"text-muted-foreground"),"data-component":"date-range-picker",children:[t.jsx(U,{className:"mr-2 h-4 w-4"}),e.from?e.to?t.jsxs(t.Fragment,{children:[l(e.from,"LLLL dd, y")," - ",l(e.to,"LLLL dd, y")]}):l(e.from,"LLLL dd, y"):t.jsx("span",{children:r.from})]})}),t.jsx(W,{className:"w-auto px-0 py-0",align:"start",children:t.jsx($,{initialFocus:!0,mode:"range",defaultMonth:e.from,selected:{from:e.from,to:e.to},onDayClick:B,numberOfMonths:2,modifiers:{today:()=>!1}})})]})})});c.displayName="DateRangePicker";c.__docgenInfo={description:"",methods:[],displayName:"DateRangePicker",props:{value:{required:!0,tsType:{name:"DateRange"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(range: DateRange) => void",signature:{arguments:[{type:{name:"DateRange"},name:"range"}],return:{name:"void"}}},description:""},placeholder:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  from?: string;
  to?: string;
