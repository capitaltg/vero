import{j as K}from"./jsx-runtime-BO8uF4Og.js";import{s as M}from"./styles-DfGEMFtJ.js";import{c as P}from"./utils-CytzSlOG.js";import{R as Q,r as m}from"./index-D4H_InIO.js";const p=Q.forwardRef(({className:B,isDisabled:F=!1,isGrowable:c=!1,...J},i)=>{const l=m.useRef(null);return m.useEffect(()=>{if(c&&l.current){const e=l.current,d=()=>{e.style.height="auto",e.style.height=`${e.scrollHeight}px`};return e.addEventListener("input",d),d(),()=>e.removeEventListener("input",d)}},[c]),K.jsx("textarea",{ref:e=>{typeof i=="function"?i(e):i&&(i.current=e),l.current=e},disabled:F,className:P(M.input,"min-h-[5rem]",c&&"resize-none overflow-hidden",B),...J})});p.displayName="Textarea";p.__docgenInfo={description:"",methods:[],displayName:"Textarea",props:{isDisabled:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},isGrowable:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}},composes:["Omit"]};const ee={title:"Components/Textarea",component:p,parameters:{},tags:["autodocs"]},t={args:{placeholder:"Type your message here..."}},a={args:{value:"This is a pre-filled textarea with some content that demonstrates how it looks with text inside it.",placeholder:"Type your message here..."}},s={args:{isDisabled:!0,placeholder:"This textarea is disabled"}},r={args:{readOnly:!0,value:"This is read-only content that cannot be modified.",placeholder:"This textarea is read-only"}},o={args:{className:"min-h-[12rem] font-mono",placeholder:"This textarea has custom styling..."}},n={args:{isGrowable:!0,placeholder:"This textarea will grow as you type..."}};var u,h,y,f,x;t.parameters={...t.parameters,docs:{...(u=t.parameters)==null?void 0:u.docs,source:{originalSource:`{
  args: {
...
Demonstrates how to apply custom styles using className.`,...(q=(k=o.parameters)==null?void 0:k.docs)==null?void 0:q.description}}};var H,L,z,I,$;n.parameters={...n.parameters,docs:{...(H=n.parameters)==null?void 0:H.docs,source:{originalSource:`{
  args: {
    isGrowable: true,
    placeholder: 'This textarea will grow as you type...'
  }
}`,...(z=(L=n.parameters)==null?void 0:L.docs)==null?void 0:z.source},description:{story:`Auto-growing textarea.
Shows how the textarea expands vertically as content is added.`,...($=(I=n.parameters)==null?void 0:I.docs)==null?void 0:$.description}}};const te=["Default","WithValue","Disabled","ReadOnly","WithCustomStyle","Growable"];export{t as Default,s as Disabled,n as Growable,r as ReadOnly,o as WithCustomStyle,a as WithValue,te as __namedExportsOrder,ee as default};
