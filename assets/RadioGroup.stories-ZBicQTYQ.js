import{j as o}from"./jsx-runtime-BO8uF4Og.js";import{r as $}from"./index-D4H_InIO.js";import{c as re}from"./utils-CytzSlOG.js";import{a as ae,R as te}from"./Radio-DSRBA1XD.js";import"./Label-BDeUq9l9.js";import"./styles-DfGEMFtJ.js";import"./index-C1hSi-0V.js";import"./index-bUn38NNn.js";import"./index-vYCkCKEW.js";import"./index-CZyo9ktw.js";import"./index-D8GmRN1t.js";import"./index-DwviEg3j.js";import"./index-DjHbRFSh.js";import"./index-DsCZslo7.js";import"./index-DAnQV6hb.js";import"./index-YtIeenAn.js";import"./index-C6Lf2F3X.js";import"./index-DXU_LAI1.js";import"./index-CIFsUU6l.js";import"./createLucideIcon-B89bYmoG.js";const h=$.forwardRef(({options:e,value:r,onChange:v,className:f,orientation:s="vertical",variant:a="default"},oe)=>o.jsx(ae,{ref:oe,value:r,onValueChange:v,className:re("grid gap-3",s==="horizontal"&&a==="default"&&"flex flex-row space-x-2",s==="vertical"&&a==="default"&&"flex flex-col gap-2 space-y-1",a==="tile"&&"grid-cols-1 md:grid-cols-2 lg:grid-cols-3",f),children:e.map(t=>o.jsx(te,{id:t.value,value:t.value,label:t.label,description:t.description,variant:a,isChecked:r===t.value},t.value))}));h.displayName="RadioGroup";h.__docgenInfo={description:"",methods:[],displayName:"RadioGroup",props:{options:{required:!0,tsType:{name:"Array",elements:[{name:"RadioOption"}],raw:"RadioOption[]"},description:""},value:{required:!0,tsType:{name:"string"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(value: string) => void",signature:{arguments:[{type:{name:"string"},name:"value"}],return:{name:"void"}}},description:""},className:{required:!1,tsType:{name:"string"},description:""},orientation:{required:!1,tsType:{name:"union",raw:"'horizontal' | 'vertical'",elements:[{name:"literal",value:"'horizontal'"},{name:"literal",value:"'vertical'"}]},description:"",defaultValue:{value:"'vertical'",computed:!1}},variant:{required:!1,tsType:{name:"union",raw:"'default' | 'tile'",elements:[{name:"literal",value:"'default'"},{name:"literal",value:"'tile'"}]},description:"",defaultValue:{value:"'default'",computed:!1}}}};const Se={title:"Components/RadioGroup",component:h,parameters:{},argTypes:{value:{control:"text",description:"Currently selected value",type:{name:"string",required:!1}},onChange:{description:"Callback when selection changes",type:{name:"function",required:!0},action:"selection changed"},options:{control:"object",description:"Array of radio options",type:{name:"array",value:{name:"object",value:{}},required:!0}},orientation:{control:"radio",options:["horizontal","vertical"],description:"Layout orientation of the radio group",type:{name:"string",required:!1}},variant:{control:"radio",options:["default","tile"],description:"Visual variant of radio buttons",type:{name:"string",required:!1}}},tags:["autodocs"]},g=[{value:"option1",label:"Option 1"},{value:"option2",label:"Option 2"},{value:"option3",label:"Option 3"}],ee=[{value:"startup",label:"Startup",description:"Perfect for new businesses and small teams"},{value:"business",label:"Business",description:"For medium-sized businesses and growing teams"},{value:"enterprise",label:"Enterprise",description:"For large organizations and enterprise teams"}],n=({value:e="",...r})=>{const[v,f]=$.useState(e);return o.jsxs("div",{className:"space-y-4",children:[o.jsx(h,{...r,value:v,onChange:s=>{var a;f(s),(a=r.onChange)==null||a.call(r,s)}}),o.jsxs("p",{className:"text-sm text-muted-foreground",children:["Selected value: ",v||"none"]})]})},i={args:{options:g,value:"",onChange:()=>{}},tags:["!autodocs"]},l={render:e=>o.jsx(n,{...e}),args:{options:g,value:"",onChange:()=>{}}},p={render:e=>o.jsx(n,{...e}),args:{options:g,value:"option2",onChange:()=>{}}},d={render:e=>o.jsx(n,{...e}),args:{options:g,value:"",onChange:()=>{},orientation:"horizontal"}},c={render:e=>o.jsx(n,{...e}),args:{options:g,value:"",onChange:()=>{},orientation:"vertical"}},u={render:e=>o.jsx(n,{...e}),args:{options:ee,value:"",onChange:()=>{},variant:"tile"}},m={render:e=>o.jsx(n,{...e}),args:{options:ee,value:"business",onChange:()=>{},variant:"tile"}};var y,R,x,w,C;i.parameters={...i.parameters,docs:{...(y=i.parameters)==null?void 0:y.docs,source:{originalSource:`{
  args: {
...
Demonstrates how tile radio options appear with an initial selection.`,...(Z=(Y=m.parameters)==null?void 0:Y.docs)==null?void 0:Z.description}}};const je=["Playground","Default","WithSelection","Horizontal","Vertical","Tile","TileWithSelection"];export{l as Default,d as Horizontal,i as Playground,u as Tile,m as TileWithSelection,c as Vertical,p as WithSelection,je as __namedExportsOrder,Se as default};
