import{j as e}from"./jsx-runtime-BO8uF4Og.js";import{s as m}from"./styles-B6VxF8L0.js";import{c as i}from"./utils-CytzSlOG.js";import{r as _}from"./index-D4H_InIO.js";import{C as k}from"./chevron-right-BRUXFm_s.js";import{c as E}from"./createLucideIcon-CRH11QI6.js";import{U as R,S as M}from"./user-CaWSvlEs.js";/**
 * @license lucide-react v0.525.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const U=[["path",{d:"M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8",key:"5wwlr5"}],["path",{d:"M3 10a2 2 0 0 1 .709-1.528l7-5.999a2 2 0 0 1 2.582 0l7 5.999A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z",key:"1d0kgt"}]],q=E("house",U),n=_.forwardRef(({items:l,separator:L=e.jsx(k,{className:"h-4 w-4"}),className:I},W)=>e.jsx("nav",{ref:W,"aria-label":"Breadcrumb",className:i("flex",I),children:e.jsx("ol",{className:"flex flex-wrap items-center gap-1",children:l.map((o,c)=>e.jsxs("li",{className:"flex items-center gap-1",children:[o.href?e.jsx("a",{href:o.href,className:i(m.link,m.linkNoUnderline),children:o.label}):e.jsx("span",{className:"font-medium text-foreground",children:o.label}),c<l.length-1?e.jsx("span",{className:"text-muted-foreground",children:L}):null]},c))})}));n.displayName="Breadcrumbs";n.__docgenInfo={description:"",methods:[],displayName:"Breadcrumbs",props:{items:{required:!0,tsType:{name:"Array",elements:[{name:"BreadcrumbItem"}],raw:"BreadcrumbItem[]"},description:""},separator:{required:!1,tsType:{name:"ReactNode"},description:"",defaultValue:{value:'<ChevronRight className="h-4 w-4" />',computed:!1}},className:{required:!1,tsType:{name:"string"},description:""}}};const K={title:"Components/Breadcrumbs",component:n,parameters:{},tags:["autodocs"]},a={args:{items:[{label:"Home",href:"/"},{label:"Documents",href:"/documents"},{label:"Current Page"}]}},s={args:{items:[{label:e.jsxs("span",{className:"flex items-center gap-1",children:[e.jsx(q,{className:"h-4 w-4"}),"Home"]}),href:"/"},{label:e.jsxs("span",{className:"flex items-center gap-1",children:[e.jsx(R,{className:"h-4 w-4"}),"Profile"]}),href:"/profile"},{label:e.jsxs("span",{className:"flex items-center gap-1",children:[e.jsx(M,{className:"h-4 w-4"}),"Settings"]})}]}},r={args:{items:[{label:"Home",href:"/"},{label:"Categories",href:"/categories"},{label:"Products"}],separator:"/"}},t={args:{items:[{label:"Home",href:"/"},{label:"Very Long Category Name That Might Wrap",href:"/category"},{label:"Even Longer Product Name That Definitely Should Wrap"}]}};var p,d,h,u,f;a.parameters={...a.parameters,docs:{...(p=a.parameters)==null?void 0:p.docs,source:{originalSource:`{
  args: {
    items: [{
      label: 'Home',
      href: '/'
...
Demonstrates how the component handles longer labels and wrapping.`,...(T=(P=t.parameters)==null?void 0:P.docs)==null?void 0:T.description}}};const Q=["Default","WithIcons","CustomSeparator","LongContent"];export{r as CustomSeparator,a as Default,t as LongContent,s as WithIcons,Q as __namedExportsOrder,K as default};
