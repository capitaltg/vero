import{j as e}from"./jsx-runtime-BO8uF4Og.js";import{P as s,a as n,b as i}from"./Popover-DHD1Bpsv.js";import{B as a}from"./Button-C_imVjo7.js";import"./index-D4H_InIO.js";import"./styles-Dlcbwdhh.js";import"./utils-CytzSlOG.js";import"./index-DB-GfMvg.js";import"./index-BekKX9Q6.js";import"./Combination-Bv7TbtME.js";import"./index-CNI2vRWb.js";import"./index-bUn38NNn.js";import"./index-vYCkCKEW.js";import"./index-DAnQV6hb.js";import"./index-BRrdJNcL.js";import"./index-Ak5Mws-w.js";import"./index-LL0F0lhE.js";import"./index-DDORxvzF.js";import"./index-DaWVWvyQ.js";import"./index-BwobEAja.js";const G={title:"Components/Popover",component:s,parameters:{},tags:["autodocs"]},r={render:()=>e.jsxs(s,{children:[e.jsx(n,{asChild:!0,children:e.jsx(a,{variant:"input",children:"Open Popover"})}),e.jsx(i,{className:"w-80",hasArrow:!0,children:e.jsxs("div",{className:"grid gap-4",children:[e.jsxs("div",{className:"space-y-2",children:[e.jsx("h4",{className:"font-medium leading-none",children:"Dimensions"}),e.jsx("p",{className:"text-sm text-muted-foreground",children:"Set the dimensions for the layer."})]}),e.jsxs("div",{className:"grid gap-2",children:[e.jsxs("div",{className:"grid grid-cols-3 items-center gap-4",children:[e.jsx("label",{htmlFor:"width",className:"text-sm",children:"Width"}),e.jsx("input",{id:"width",defaultValue:"100%",className:"col-span-2 h-8 rounded-md border border-input bg-transparent px-3 text-sm"})]}),e.jsxs("div",{className:"grid grid-cols-3 items-center gap-4",children:[e.jsx("label",{htmlFor:"height",className:"text-sm",children:"Height"}),e.jsx("input",{id:"height",defaultValue:"25px",className:"col-span-2 h-8 rounded-md border border-input bg-transparent px-3 text-sm"})]})]})]})})]})},t={render:()=>e.jsxs(s,{children:[e.jsx(n,{asChild:!0,children:e.jsx(a,{variant:"input",children:"Open Popover"})}),e.jsx(i,{className:"w-80",children:e.jsx("p",{className:"text-sm",children:"This is a simple popover without an arrow."})})]})},o={render:()=>e.jsxs(s,{children:[e.jsx(n,{asChild:!0,children:e.jsx(a,{variant:"input",children:"Open Popover"})}),e.jsx(i,{className:"w-80",align:"start",hasArrow:!0,children:e.jsx("p",{className:"text-sm",children:"This popover is aligned to the start."})})]})};var p,d,m,l,c;r.parameters={...r.parameters,docs:{...(p=r.parameters)==null?void 0:p.docs,source:{originalSource:`{
  render: () => <Popover>
        ...
        <div className="grid gap-4">
          ...
          <div className="grid gap-2">
            <div className="grid grid-cols-3 items-center gap-4">
              ...
              <input id="width" defaultValue="100%" className="col-span-2 h-8 rounded-md border border-input bg-transparent px-3 text-sm" />
            </div>
            <div className="grid grid-cols-3 items-center gap-4">
              <label htmlFor="height" className="text-sm">
                Height
              </label>
              <input id="height" defaultValue="25px" className="col-span-2 h-8 rounded-md border border-input bg-transparent px-3 text-sm" />
            </div>
          </div>
        </div>
      </PopoverContent>
...
Demonstrates how to control the alignment of the popover relative to its trigger.`,...(b=(j=o.parameters)==null?void 0:j.docs)==null?void 0:b.description}}};const I=["WithArrow","WithoutArrow","CustomPosition"];export{o as CustomPosition,r as WithArrow,t as WithoutArrow,I as __namedExportsOrder,G as default};
