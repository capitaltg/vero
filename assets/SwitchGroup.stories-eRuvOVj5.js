...
Shows a group of switches arranged in a single column with no initial selections.`,...(k=(G=i.parameters)==null?void 0:G.docs)==null?void 0:k.description}}};var q,I,T,A,N;c.parameters={...c.parameters,docs:{...(q=c.parameters)==null?void 0:q.docs,source:{originalSource:`{
  render: args => <SwitchGroupDemo {...args} />,
  args: {
    options,
...
}`,...(T=(I=c.parameters)==null?void 0:I.docs)==null?void 0:T.source},description:{story:`SwitchGroup with pre-selected values.
Demonstrates how the group appears with multiple switches toggled on.`,...(N=(A=c.parameters)==null?void 0:A.docs)==null?void 0:N.description}}};var R,O,E,W,_;l.parameters={...l.parameters,docs:{...(R=l.parameters)==null?void 0:R.docs,source:{originalSource:`{
  render: args => <SwitchGroupDemo {...args} />,
  args: {
    options,
    columns: 1,
...
Demonstrates how switches can be arranged in multiple columns.`,...(P=(L=d.parameters)==null?void 0:L.docs)==null?void 0:P.description}}};var V,F,$,z,H;u.parameters={...u.parameters,docs:{...(V=u.parameters)==null?void 0:V.docs,source:{originalSource:`{
  render: args => <SwitchGroupDemo {...args} />,
  args: {
    options: [...options, {
      id: 'backup',
...
}`,...($=(F=u.parameters)==null?void 0:F.docs)==null?void 0:$.source},description:{story:`SwitchGroup with an extended list of options.
Shows how the component handles a larger set of switches, including disabled states.`,...(H=(z=u.parameters)==null?void 0:z.docs)==null?void 0:H.description}}};const Se=["Playground","Default","WithSelection","SingleColumn","ThreeColumns","WithManyOptions"];export{i as Default,o as Playground,l as SingleColumn,d as ThreeColumns,u as WithManyOptions,c as WithSelection,Se as __namedExportsOrder,fe as default};
