import{j as e}from"./jsx-runtime-DSvmvvsx.js";import{r as l}from"./index-B0WjJBI_.js";import{C as r}from"./Combobox-CN7rOkAZ.js";import"./_commonjsHelpers-CqkleIqs.js";import"./Button-BinwIYAK.js";import"./useAriaDisabled-BVkOu7OW.js";import"./utils-CU3My8Oi.js";import"./index-BOrrHd12.js";import"./index-EiwPuDyL.js";import"./constants-D9UEAID0.js";import"./styles-CafxXXJc.js";import"./index-NE6MC3wq.js";import"./createLucideIcon-BeEkWZrd.js";import"./CommandItem-C4rLDUnH.js";import"./index-CoRj-x2w.js";import"./index-KklXjS-Z.js";import"./index-CwPCC0ZT.js";import"./index-CoMQ7c9D.js";import"./index-B5oA2Zbg.js";import"./index-Cdcq5Wwr.js";import"./index-DKzZmXCh.js";import"./index-OiR64VEf.js";import"./index-BllD4pgw.js";import"./index-BHtEszHx.js";import"./CommandGroup-Xi_G_xj6.js";import"./CommandList-DEuvlimI.js";import"./Popover-D7LnbHHd.js";import"./z-index-CmEG1ohp.js";import"./index-DKWC2_YT.js";import"./floating-ui.react-dom-Dsj8ROC4.js";import"./index-DBA0bpW4.js";import"./chevrons-up-down-CPJXHd7n.js";import"./check-C42IfL-F.js";const Q=[{value:"US",label:"United States"},{value:"CA",label:"Canada"},{value:"GB",label:"United Kingdom"},{value:"MX",label:"Mexico"},{value:"AU",label:"Australia"}],Y=(o,t)=>{const a=t.toLowerCase().trim();return a.length===0||o.toLowerCase()===a?1:0},X=({value:o="",...t})=>{const[a,s]=l.useState(o);return e.jsxs("div",{className:"space-y-4",children:[e.jsx(r,{...t,filter:Y,options:Q,placeholder:"Select country...",searchPlaceholder:"Type exact code (e.g. US, CA, GB)...",value:a,onChange:s}),e.jsxs("p",{className:"text-sm text-muted-foreground",children:["Selected value (programmatic):"," ",e.jsx("code",{className:"rounded bg-muted px-1",children:a||"none"})]}),e.jsxs("p",{className:"text-sm text-muted-foreground",children:["This example uses a custom filter: only the option whose value ",e.jsx("em",{children:"exactly"}),' matches your search is shown (e.g. type "US" to see United States). Leave the search empty to see all options.']})]})};X.__docgenInfo={description:"",methods:[],displayName:"ComboboxCustomFilter",props:{value:{defaultValue:{value:"''",computed:!1},required:!1}}};const ee=`import { useState } from 'react';
...
}`,...(O=(E=d.parameters)==null?void 0:E.docs)==null?void 0:O.source},description:{story:"Uses a fixed-width trigger (demonstrates ellipsis when the label is too long). Popover\nuses `min-w-[--radix-popover-trigger-width]` so it is at least as wide as the trigger\nbut can grow when option labels are longer - the dropdown expands to fit the content.",...(L=(K=d.parameters)==null?void 0:K.docs)==null?void 0:L.description}}};const $e=["Playground","Default","WithValue","CustomPlaceholders","Filtering","CustomFilter","MinWidthPopover"];export{p as CustomFilter,c as CustomPlaceholders,i as Default,m as Filtering,d as MinWidthPopover,n as Playground,u as WithValue,$e as __namedExportsOrder,Xe as default};
