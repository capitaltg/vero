import{j as e}from"./jsx-runtime-BO8uF4Og.js";import{R as ee,r as U}from"./index-D4H_InIO.js";import{c as f}from"./utils-l21BANrb.js";import{B as re}from"./Button-DyzmSwPh.js";import{C as ae,a as te,b as se,c as oe,d as ne}from"./CommandItem-xfb4P4v8.js";import{C as le,a as ie}from"./CommandList-DVBTa2PJ.js";import{P as ce,a as me,b as de}from"./Popover-Dw8x3uOg.js";import{C as pe}from"./check-CT0OM3mY.js";import{X as ue}from"./x-B9-lGSIk.js";import"./index-CZyo9ktw.js";import"./index-D8GmRN1t.js";import"./constants-CYoSQ_7E.js";import"./styles-6b-8-onS.js";import"./index-DKzzznqW.js";import"./index-C1hSi-0V.js";import"./index-bUn38NNn.js";import"./index-vYCkCKEW.js";import"./createLucideIcon-CRH11QI6.js";import"./index-D9Bpvn5I.js";import"./index-DwviEg3j.js";import"./index-DsCZslo7.js";import"./index-DXGtwV5R.js";import"./index-DAnQV6hb.js";import"./index-Dg2NYmXS.js";import"./index-CIFsUU6l.js";import"./index-CHmAJ0Sv.js";import"./floating-ui.react-dom-Cto5zZXc.js";import"./index-C6Lf2F3X.js";const p=ee.forwardRef(({options:a,value:t,onChange:o,placeholder:h="Select items...",searchPlaceholder:z="Search items...",emptyMessage:X="No items found",className:$,listClassName:F,...H},J)=>{const[x,K]=U.useState(!1),Q=t.map(r=>{var s;return((s=a.find(g=>g.value===r))==null?void 0:s.label)||r}),Y=()=>t.length===0?e.jsx("span",{className:"self-center text-muted-foreground",children:h}):e.jsx("div",{className:"flex flex-1 flex-wrap gap-1",children:Q.map((r,s)=>e.jsxs("div",{className:"flex items-center gap-1 rounded-sm bg-secondary px-2 py-0.5 text-sm text-secondary-foreground",children:[r,e.jsx(ue,{role:"button","aria-label":`Remove ${r}`,className:"h-3 w-3 cursor-pointer opacity-50 hover:opacity-100",strokeWidth:3,onClick:g=>{g.stopPropagation(),o(t.filter((he,Z)=>Z!==s))}})]},t[s]))});return e.jsxs(ce,{open:x,onOpenChange:K,children:[e.jsx(me,{asChild:!0,children:e.jsxs(re,{ref:J,variant:"input",role:"combobox","aria-expanded":x,className:f("flex h-auto min-h-[2.5rem] w-full items-stretch justify-between px-3 py-1.5",$),...H,children:[e.jsx("div",{className:"flex flex-1 text-left",children:Y()}),e.jsx(le,{className:"ml-2 h-4 w-4 shrink-0 self-center opacity-50"})]})}),e.jsx(de,{align:"start",className:"w-[--radix-popover-trigger-width] px-0 py-0",children:e.jsxs(ae,{children:[e.jsx(te,{placeholder:z}),e.jsxs(ie,{className:f("max-h-[16.5rem] overflow-y-auto",F),children:[e.jsx(se,{children:X}),e.jsx(oe,{children:a.map(r=>e.jsx(ne,{value:r.value,onSelect:()=>{o(t.includes(r.value)?t.filter(s=>s!==r.value):[...t,r.value])},children:e.jsxs("div",{className:"flex items-center",children:[e.jsx("div",{className:f("mr-2 flex h-4 w-4 items-center justify-center rounded-sm border border-primary-400",t.includes(r.value)?"bg-primary-400 text-white":"opacity-50"),children:t.includes(r.value)?e.jsx(pe,{className:"h-3 w-3",strokeWidth:3}):null}),r.label]})},r.value))})]})]})})]})});p.displayName="MultiSelect";p.__docgenInfo={description:"",methods:[],displayName:"MultiSelect",props:{options:{required:!0,tsType:{name:"Array",elements:[{name:"MultiSelectOption"}],raw:"MultiSelectOption[]"},description:""},value:{required:!0,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(value: string[]) => void",signature:{arguments:[{type:{name:"Array",elements:[{name:"string"}],raw:"string[]"},name:"value"}],return:{name:"void"}}},description:""},placeholder:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"'Select items...'",computed:!1}},searchPlaceholder:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"'Search items...'",computed:!1}},emptyMessage:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"'No items found'",computed:!1}},className:{required:!1,tsType:{name:"string"},description:""},listClassName:{required:!1,tsType:{name:"string"},description:""}}};const Ue={title:"Components/MultiSelect",component:p,parameters:{},tags:["autodocs"]},d=[{value:"react",label:"React"},{value:"vue",label:"Vue"},{value:"angular",label:"Angular"},{value:"svelte",label:"Svelte"},{value:"solid",label:"Solid"}],u=({value:a=[],...t})=>{const[o,h]=U.useState(a);return e.jsxs("div",{className:"space-y-4",children:[e.jsx(p,{...t,value:o,onChange:h}),e.jsxs("p",{className:"text-sm text-muted-foreground",children:["Selected values: ",o.length>0?o.join(", "):"none"]})]})},n={args:{options:d,value:[],onChange:()=>{},placeholder:"Select frameworks..."},tags:["!autodocs"]},l={render:a=>e.jsx(u,{...a}),args:{options:d,value:[],onChange:()=>{},placeholder:"Select frameworks..."}},i={render:a=>e.jsx(u,{...a}),args:{options:d,value:["react","vue"],onChange:()=>{},placeholder:"Select frameworks..."}},c={render:a=>e.jsx(u,{...a}),args:{options:d,value:[],onChange:()=>{},placeholder:"Choose your frameworks",searchPlaceholder:"Search frameworks...",emptyMessage:"No frameworks found"}},m={render:a=>e.jsx(u,{...a}),args:{options:[...d,{value:"next",label:"Next.js"},{value:"nuxt",label:"Nuxt.js"},{value:"gatsby",label:"Gatsby"},{value:"remix",label:"Remix"},{value:"astro",label:"Astro"}],value:[],onChange:()=>{},placeholder:"Select frameworks..."}};var v,y,w,S,j;n.parameters={...n.parameters,docs:{...(v=n.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
    options,
    value: [],
    onChange: () => {},
...
Demonstrates how the component handles a larger set of choices with scrolling.`,...(L=(B=m.parameters)==null?void 0:B.docs)==null?void 0:L.description}}};const ze=["Playground","Default","WithSelection","CustomPlaceholders","WithManyOptions"];export{c as CustomPlaceholders,l as Default,n as Playground,m as WithManyOptions,i as WithSelection,ze as __namedExportsOrder,Ue as default};
