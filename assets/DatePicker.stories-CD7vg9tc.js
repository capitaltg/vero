import{j as e}from"./jsx-runtime-BO8uF4Og.js";import{r as q}from"./index-D4H_InIO.js";import{P as _,a as E,b as R}from"./Popover-MkULWHLn.js";import{c as B}from"./utils-CytzSlOG.js";import{B as I}from"./Button-uIRB2Tw7.js";import{f as W,C as z,a as F}from"./Calendar-DB6e_aY3.js";import"./styles-B6VxF8L0.js";import"./index-DwviEg3j.js";import"./index-D8GmRN1t.js";import"./index-DXGtwV5R.js";import"./index-C1hSi-0V.js";import"./index-bUn38NNn.js";import"./index-vYCkCKEW.js";import"./index-CZyo9ktw.js";import"./index-DAnQV6hb.js";import"./index-Dg2NYmXS.js";import"./index-DsCZslo7.js";import"./index-CHmAJ0Sv.js";import"./floating-ui.react-dom-Cto5zZXc.js";import"./index-C6Lf2F3X.js";import"./index-CIFsUU6l.js";import"./constants-DQNtG7xk.js";import"./index-BwobEAja.js";import"./createLucideIcon-CRH11QI6.js";import"./chevron-right-BRUXFm_s.js";const i=q.forwardRef(({value:a,onChange:c,placeholder:r="Pick a date",className:d},V)=>e.jsxs(_,{children:[e.jsx(E,{asChild:!0,children:e.jsxs(I,{ref:V,variant:"input",className:B("w-full justify-start px-3 text-left font-normal",!a&&"text-muted-foreground",d),"data-component":"date-picker",children:[e.jsx(z,{className:"mr-2 h-4 w-4"}),a?W(a,"LLLL dd, y"):e.jsx("span",{children:r})]})}),e.jsx(R,{className:"w-auto px-0 py-0",align:"start",children:e.jsx(F,{mode:"single",selected:a,onSelect:c,autoFocus:!0})})]}));i.displayName="DatePicker";i.__docgenInfo={description:"",methods:[],displayName:"DatePicker",props:{value:{required:!1,tsType:{name:"Date"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(date?: Date) => void",signature:{arguments:[{type:{name:"Date"},name:"date"}],return:{name:"void"}}},description:""},placeholder:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"'Pick a date'",computed:!1}},className:{required:!1,tsType:{name:"string"},description:""}}};const le={title:"Components/DatePicker",component:i,parameters:{},tags:["autodocs"]},p=({value:a,...c})=>{const[r,d]=q.useState(a);return e.jsxs("div",{className:"space-y-4",children:[e.jsx(i,{...c,value:r,onChange:d}),e.jsxs("p",{className:"text-sm text-muted-foreground",children:["Selected date: ",r?r.toLocaleDateString():"none"]})]})},t={args:{value:void 0,onChange:()=>{},placeholder:"Pick a date"},tags:["!autodocs"]},o={render:a=>e.jsx(p,{...a}),args:{value:void 0,onChange:()=>{},placeholder:"Pick a date"}},s={render:a=>e.jsx(p,{...a}),args:{value:new Date("2024-03-15"),onChange:()=>{},placeholder:"Pick a date"}},n={render:a=>e.jsx(p,{...a}),args:{value:void 0,onChange:()=>{},placeholder:"Select your birthday"}};var m,l,u,h,g;t.parameters={...t.parameters,docs:{...(m=t.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    value: undefined,
    onChange: () => {},
