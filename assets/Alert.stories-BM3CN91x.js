...
Demonstrates how to hide the status icon while maintaining the alert's structure.`,...(le=(ce=l.parameters)==null?void 0:ce.docs)==null?void 0:le.description}}};var de,he,me,ue,pe;d.parameters={...d.parameters,docs:{...(de=d.parameters)==null?void 0:de.docs,source:{originalSource:`{
  args: {
    variant: 'success',
    size: 'sm',
    children: 'Your changes have been saved successfully.'
  }
}`,...(me=(he=d.parameters)==null?void 0:he.docs)==null?void 0:me.source},description:{story:`A compact success alert without a heading.
Shows the alert's appearance when only displaying the message content.`,...(pe=(ue=d.parameters)==null?void 0:ue.docs)==null?void 0:pe.description}}};var ge,ve,fe,ye,we;h.parameters={...h.parameters,docs:{...(ge=h.parameters)==null?void 0:ge.docs,source:{originalSource:`{
  args: {
    variant: 'success',
    size: 'sm',
    children: 'Your changes have been saved successfully.',
...
Demonstrates the layout when combining the icon with message content only.`,...(we=(ye=h.parameters)==null?void 0:ye.docs)==null?void 0:we.description}}};var be,Se,Ae,Ie,xe;m.parameters={...m.parameters,docs:{...(be=m.parameters)==null?void 0:be.docs,source:{originalSource:`{
...
}`,...(Ae=(Se=m.parameters)==null?void 0:Se.docs)==null?void 0:Ae.source},description:{story:`A closable alert.
Shows how to add a close button to dismiss the alert.`,...(xe=(Ie=m.parameters)==null?void 0:Ie.docs)==null?void 0:xe.description}}};var Te,Ne,Ce,je,ze;u.parameters={...u.parameters,docs:{...(Te=u.parameters)==null?void 0:Te.docs,source:{originalSource:`{
  args: {
    variant: 'info',
    heading: 'H3 Heading',
    headingLevel: 'h3',
...
}`,...(Ce=(Ne=u.parameters)==null?void 0:Ne.docs)==null?void 0:Ce.source},description:{story:`An alert with a custom heading level.
Demonstrates how to adjust the semantic heading level for accessibility.`,...(ze=(je=u.parameters)==null?void 0:je.docs)==null?void 0:ze.description}}};var De,He,ke,Ye,Be;p.parameters={...p.parameters,docs:{...(De=p.parameters)==null?void 0:De.docs,source:{originalSource:`{
  args: {
    variant: 'info',
...
Used to confirm critical actions like deletions or irreversible changes.`,...(We=(Re=g.parameters)==null?void 0:Re.docs)==null?void 0:We.description}}};const oa=["Success","Warning","Danger","Info","NoIcon","NoHeading","NoIconNoHeading","Small","SmallNoIcon","SmallNoHeading","SmallNoIconNoHeading","Closable","CustomHeadingLevel","RichContent","ConfirmationAction"];export{m as Closable,g as ConfirmationAction,u as CustomHeadingLevel,n as Danger,r as Info,o as NoHeading,t as NoIcon,i as NoIconNoHeading,p as RichContent,c as Small,d as SmallNoHeading,l as SmallNoIcon,h as SmallNoIconNoHeading,a as Success,s as Warning,oa as __namedExportsOrder,ta as default};
