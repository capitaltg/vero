...
`,Ft={title:"Actions & Navigation/Tabs",component:P,parameters:{},tags:["autodocs"],argTypes:{value:{control:"text",description:"The controlled value of the active tab. When provided, the component becomes a controlled component.",table:{type:{summary:"string"}}},defaultValue:{control:"text",description:"The default value of the active tab when the component is uncontrolled.",table:{type:{summary:"string"}}}}},F={args:{defaultValue:"account"},render:e=>o.jsx(Le,{...e}),parameters:{docs:{source:{code:vt}}}},D={args:{defaultValue:"active"},render:e=>o.jsx(We,{...e}),parameters:{docs:{source:{code:Tt}}}},M={args:{defaultValue:"tab1"},render:e=>o.jsx(Ve,{...e}),parameters:{docs:{source:{code:gt}}}};var J,Q,X,ee,te;F.parameters={...F.parameters,docs:{...(J=F.parameters)==null?void 0:J.docs,source:{originalSource:`{
  args: {
