...
}`,...(_=(L=m.parameters)==null?void 0:L.docs)==null?void 0:_.source},description:{story:"Uses a fixed-width trigger (demonstrates ellipsis when the label is too long). Popover\nuses `popoverClassName` so it can be wider than the trigger - the dropdown expands to\nfit long option labels.",...(E=(z=m.parameters)==null?void 0:z.docs)==null?void 0:E.description}}};const Ee=["Playground","Default","WithStaticOptions","WithCustomRender","WithItemCallback","MinWidthPopover"];export{p as Default,m as MinWidthPopover,l as Playground,c as WithCustomRender,d as WithItemCallback,u as WithStaticOptions,Ee as __namedExportsOrder,ze as default};
