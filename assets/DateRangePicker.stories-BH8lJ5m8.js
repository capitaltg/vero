import{j as t}from"./jsx-runtime-BO8uF4Og.js";import{r as V}from"./index-D4H_InIO.js";import{c as f}from"./utils-l21BANrb.js";import{g as M}from"./z-index-CmEG1ohp.js";import{B as Z}from"./Button-eEoo75We.js";import{C as U,f as l,a as $,b as A}from"./Calendar-D_gUg_5t.js";import{P as G,a as H,b as J}from"./Popover-BMLVvNmP.js";import"./index-CZyo9ktw.js";import"./index-D8GmRN1t.js";import"./constants-CYXQNxVE.js";import"./styles-B37qHJ5_.js";import"./index-DKzzznqW.js";import"./createLucideIcon-CRH11QI6.js";import"./chevron-right-BRUXFm_s.js";import"./index-DwviEg3j.js";import"./index-DXGtwV5R.js";import"./index-C1hSi-0V.js";import"./index-bUn38NNn.js";import"./index-vYCkCKEW.js";import"./index-DAnQV6hb.js";import"./index-Dg2NYmXS.js";import"./index-DsCZslo7.js";import"./index-CHmAJ0Sv.js";import"./floating-ui.react-dom-Cto5zZXc.js";import"./index-C6Lf2F3X.js";import"./index-CIFsUU6l.js";const c=V.forwardRef(({value:e,onChange:a,placeholder:o={from:"Pick start date",to:"Pick end date"},className:p,zIndex:W,..._},z)=>{const F=M("popover",W),O=r=>{const{from:n,to:B}=e;if(!n)return a({from:r,to:void 0});if(r<n)return a({from:r,to:void 0});if(n&&B)return a({from:r,to:void 0});if(r>n)return a({from:n,to:r});if(r.getTime()===n.getTime())return a({from:void 0,to:void 0})};return t.jsx("div",{className:f("grid gap-2",p),children:t.jsxs(G,{children:[t.jsx(H,{asChild:!0,children:t.jsxs(Z,{ref:z,id:"date",variant:"input",className:f("w-full justify-start px-3 text-left font-normal",!e.from&&!e.to&&"text-muted-foreground"),..._,"data-component":"date-range-picker",children:[t.jsx(U,{className:"mr-2 h-4 w-4"}),e.from?e.to?t.jsxs(t.Fragment,{children:[l(e.from,"LLLL dd, y")," - ",l(e.to,"LLLL dd, y")]}):l(e.from,"LLLL dd, y"):t.jsx("span",{children:o.from})]})}),t.jsx(J,{className:"w-auto px-0 py-0",align:"start",zIndex:F,children:t.jsx($,{autoFocus:!0,mode:"range",defaultMonth:e.from,selected:{from:e.from,to:e.to},onSelect:r=>{r&&a(r)},showOutsideDays:!1,onDayClick:O,numberOfMonths:2,modifiers:{today:()=>!1}})})]})})});c.displayName="DateRangePicker";c.__docgenInfo={description:"",methods:[],displayName:"DateRangePicker",props:{value:{required:!0,tsType:{name:"DateRange"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(range: DateRange) => void",signature:{arguments:[{type:{name:"DateRange"},name:"range"}],return:{name:"void"}}},description:""},placeholder:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  from?: string;
  to?: string;
...
Shows the basic date range picker with no pre-selected dates.`,...(j=(w=i.parameters)==null?void 0:w.docs)==null?void 0:j.description}}};var C,R,S,L,E;d.parameters={...d.parameters,docs:{...(C=d.parameters)==null?void 0:C.docs,source:{originalSource:`{
  render: args => <DateRangePickerDemo {...args} />,
  args: {
    value: {
...
Demonstrates how the component appears with initial start and end dates.`,...(E=(L=d.parameters)==null?void 0:L.docs)==null?void 0:E.description}}};var N,T,b,q,I;m.parameters={...m.parameters,docs:{...(N=m.parameters)==null?void 0:N.docs,source:{originalSource:`{
  render: args => <DateRangePickerDemo {...args} />,
  args: {
    value: {},
    onChange: () => {},
...
Shows how to customize the placeholder messages for both start and end dates.`,...(I=(q=m.parameters)==null?void 0:q.docs)==null?void 0:I.description}}};const we=["Playground","Default","WithValue","CustomPlaceholders"];export{m as CustomPlaceholders,i as Default,s as Playground,d as WithValue,we as __namedExportsOrder,ve as default};
