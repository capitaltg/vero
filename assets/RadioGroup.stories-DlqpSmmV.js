import{j as o}from"./jsx-runtime-BO8uF4Og.js";import{r as fe}from"./index-D4H_InIO.js";import{c as xe}from"./utils-CytzSlOG.js";import{a as we,R as Re}from"./Radio-C64wB-pb.js";import"./constants-DQNtG7xk.js";import"./styles-B6VxF8L0.js";import"./index-BwobEAja.js";import"./Label-Yaiz0i84.js";import"./index-C1hSi-0V.js";import"./index-bUn38NNn.js";import"./index-vYCkCKEW.js";import"./index-CZyo9ktw.js";import"./index-D8GmRN1t.js";import"./index-DwviEg3j.js";import"./index-DjHbRFSh.js";import"./index-DsCZslo7.js";import"./index-DAnQV6hb.js";import"./index-YtIeenAn.js";import"./index-C6Lf2F3X.js";import"./index-DXU_LAI1.js";import"./index-CIFsUU6l.js";import"./createLucideIcon-CRH11QI6.js";const b=fe.forwardRef(({options:e,value:n,onChange:y,className:x,orientation:s="vertical",variant:t="default"},be)=>o.jsx(we,{ref:be,value:n,onValueChange:y,className:xe("grid gap-3",s==="horizontal"&&t==="default"&&"flex flex-row gap-5",s==="vertical"&&t==="default"&&"flex flex-col gap-2 space-y-1",t==="tile"&&"grid-cols-1 md:grid-cols-2 lg:grid-cols-3",t==="button"&&s==="horizontal"&&"flex flex-row gap-0 [&>*:first-child]:ml-0 [&>*:first-child]:rounded-l-sm [&>*:last-child]:rounded-r-sm [&>*]:-ml-[1px] [&>*]:rounded-none",t==="button"&&s==="vertical"&&"flex flex-col gap-0 [&>*:first-child]:mt-0 [&>*:first-child]:rounded-t-sm [&>*:last-child]:rounded-b-sm [&>*]:-mt-[1px] [&>*]:rounded-none",x),children:e.map(i=>o.jsx(Re,{id:i.value,value:i.value,label:i.label,description:i.description,variant:t,isChecked:n===i.value},i.value))}));b.displayName="RadioGroup";b.__docgenInfo={description:"",methods:[],displayName:"RadioGroup",props:{options:{required:!0,tsType:{name:"Array",elements:[{name:"RadioOption"}],raw:"RadioOption[]"},description:""},value:{required:!0,tsType:{name:"string"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(value: string) => void",signature:{arguments:[{type:{name:"string"},name:"value"}],return:{name:"void"}}},description:""},className:{required:!1,tsType:{name:"string"},description:""},orientation:{required:!1,tsType:{name:"union",raw:"'horizontal' | 'vertical'",elements:[{name:"literal",value:"'horizontal'"},{name:"literal",value:"'vertical'"}]},description:"",defaultValue:{value:"'vertical'",computed:!1}},variant:{required:!1,tsType:{name:"union",raw:"'default' | 'tile' | 'button'",elements:[{name:"literal",value:"'default'"},{name:"literal",value:"'tile'"},{name:"literal",value:"'button'"}]},description:"",defaultValue:{value:"'default'",computed:!1}}}};const Ue={title:"Components/RadioGroup",component:b,parameters:{},argTypes:{value:{control:"text",description:"Currently selected value",type:{name:"string",required:!1}},onChange:{description:"Callback when selection changes",type:{name:"function",required:!0},action:"selection changed"},options:{control:"object",description:"Array of radio options",type:{name:"array",value:{name:"object",value:{}},required:!0}},orientation:{control:"radio",options:["horizontal","vertical"],description:"Layout orientation of the radio group (only applies to default and button variants)",type:{name:"string",required:!1},table:{type:{summary:"horizontal | vertical"}}},variant:{control:"radio",options:["default","tile","button"],description:"Visual variant of radio buttons",type:{name:"string",required:!1},table:{type:{summary:"default | tile | button"}}}},tags:["autodocs"]},a=[{value:"option1",label:"Option 1"},{value:"option2",label:"Option 2"},{value:"option3",label:"Option 3"}],ye=[{value:"startup",label:"Startup",description:"Perfect for new businesses and small teams"},{value:"business",label:"Business",description:"For medium-sized businesses and growing teams"},{value:"enterprise",label:"Enterprise",description:"For large organizations and enterprise teams"}],r=({value:e="",...n})=>{const[y,x]=fe.useState(e);return o.jsxs("div",{className:"space-y-4",children:[o.jsx(b,{...n,value:y,onChange:s=>{var t;x(s),(t=n.onChange)==null||t.call(n,s)}}),o.jsxs("p",{className:"text-sm text-muted-foreground",children:["Selected value: ",y||"none"]})]})},l={args:{options:a,value:"",onChange:()=>{}},tags:["!autodocs"]},p={render:e=>o.jsx(r,{...e}),args:{options:a,value:"",onChange:()=>{}}},d={render:e=>o.jsx(r,{...e}),args:{options:a,value:"option2",onChange:()=>{}}},u={render:e=>o.jsx(r,{...e}),args:{options:a,value:"",onChange:()=>{},orientation:"horizontal"}},c={render:e=>o.jsx(r,{...e}),args:{options:a,value:"",onChange:()=>{},orientation:"vertical"}},m={render:e=>o.jsx(r,{...e}),args:{options:ye,value:"",onChange:()=>{},variant:"tile"}},g={render:e=>o.jsx(r,{...e}),args:{options:ye,value:"business",onChange:()=>{},variant:"tile"}},h={render:e=>o.jsx(r,{...e}),args:{options:a,value:"",onChange:()=>{},variant:"button",orientation:"horizontal"}},v={render:e=>o.jsx(r,{...e}),args:{options:a,value:"",onChange:()=>{},variant:"button",orientation:"vertical"}},f={render:e=>o.jsx(r,{...e}),args:{options:a,value:"option2",onChange:()=>{},variant:"button"}};var w,R,C,S,G;l.parameters={...l.parameters,docs:{...(w=l.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
...
Demonstrates how the group appears with an initial selection.`,...(W=(N=d.parameters)==null?void 0:N.docs)==null?void 0:W.description}}};var E,_,k,P,A;u.parameters={...u.parameters,docs:{...(E=u.parameters)==null?void 0:E.docs,source:{originalSource:`{
  render: args => <RadioGroupDemo {...args} />,
  args: {
    options: defaultOptions,
    value: '',
...
Shows radio options arranged in a horizontal line.`,...(A=(P=u.parameters)==null?void 0:P.docs)==null?void 0:A.description}}};var F,H,I,L,U;c.parameters={...c.parameters,docs:{...(F=c.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: args => <RadioGroupDemo {...args} />,
  args: {
    options: defaultOptions,
    value: '',
...
}`,...(I=(H=c.parameters)==null?void 0:H.docs)==null?void 0:I.source},description:{story:`RadioGroup with vertical layout.
...
Demonstrates how button radio options appear with an initial selection.`,...(ve=(he=f.parameters)==null?void 0:he.docs)==null?void 0:ve.description}}};const Je=["Playground","Default","WithSelection","Horizontal","Vertical","Tile","TileWithSelection","Button","ButtonVertical","ButtonWithSelection"];export{h as Button,v as ButtonVertical,f as ButtonWithSelection,p as Default,u as Horizontal,l as Playground,m as Tile,g as TileWithSelection,c as Vertical,d as WithSelection,Je as __namedExportsOrder,Ue as default};
