...
Use the controls to experiment with different props and states.`,...(_=(K=f.parameters)==null?void 0:K.docs)==null?void 0:_.description}}};var U,B,F,L,O;y.parameters={...y.parameters,docs:{...(U=y.parameters)==null?void 0:U.docs,source:{originalSource:`{
  args: {
    value: [{
      id: '1',
      text: 'React'
...
}`,...(F=(B=y.parameters)==null?void 0:B.docs)==null?void 0:F.source},description:{story:`The default state of the TagInput component.
...
Demonstrates using multiple characters (comma, space, and pipe) to create tags.`,...(fe=(he=D.parameters)==null?void 0:he.docs)==null?void 0:fe.description}}};const qe=["Playground","Default","Empty","Disabled","WithMaxTags","WithSingleDelimiter","WithMultipleDelimiters"];export{y as Default,x as Disabled,T as Empty,f as Playground,w as WithMaxTags,D as WithMultipleDelimiters,R as WithSingleDelimiter,qe as __namedExportsOrder,Pe as default};
