...
}`,...(O=(E=d.parameters)==null?void 0:E.docs)==null?void 0:O.source},description:{story:"Uses a fixed-width trigger (demonstrates ellipsis when the label is too long). Popover\nuses `min-w-[--radix-popover-trigger-width]` so it is at least as wide as the trigger\nbut can grow when option labels are longer - the dropdown expands to fit the content.",...(L=(K=d.parameters)==null?void 0:K.docs)==null?void 0:L.description}}};const Xe=["Playground","Default","WithValue","CustomPlaceholders","Filtering","CustomFilter","MinWidthPopover"];export{p as CustomFilter,c as CustomPlaceholders,i as Default,m as Filtering,d as MinWidthPopover,n as Playground,u as WithValue,Xe as __namedExportsOrder,Le as default};
