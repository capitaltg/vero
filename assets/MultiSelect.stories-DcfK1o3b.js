import{j as e}from"./jsx-runtime-BO8uF4Og.js";import{M as u}from"./MultiSelect-CuxF2CuD.js";import{r as i}from"./index-D4H_InIO.js";import"./utils-CU3My8Oi.js";import"./z-index-CmEG1ohp.js";import"./Button-Dp8g_T52.js";import"./useAriaDisabled-DHTVgRPt.js";import"./index-CZyo9ktw.js";import"./index-D8GmRN1t.js";import"./constants-CVEkm9yF.js";import"./styles-BasBkTzl.js";import"./index-NE6MC3wq.js";import"./createLucideIcon-CRH11QI6.js";import"./CommandItem-CiFaxsn-.js";import"./index-C1hSi-0V.js";import"./index-bUn38NNn.js";import"./index-vYCkCKEW.js";import"./index-CQ-IqFoI.js";import"./index-DB-GfMvg.js";import"./index-Ak5Mws-w.js";import"./index-CWZjxdH8.js";import"./index-DAnQV6hb.js";import"./index-Dg2NYmXS.js";import"./index-DLaBReRc.js";import"./CommandList-DmlIjmFM.js";import"./Popover-DBV-TgdM.js";import"./index-BnJEnLsy.js";import"./floating-ui.react-dom-Cto5zZXc.js";import"./index-DDORxvzF.js";import"./check-CT0OM3mY.js";import"./x-B9-lGSIk.js";const z=[{value:"react",label:"React"},{value:"vue",label:"Vue"},{value:"angular",label:"Angular"},{value:"svelte",label:"Svelte"},{value:"solid",label:"Solid"}],I=()=>{const[t,a]=i.useState([]);return e.jsxs("div",{className:"space-y-4",children:[e.jsx(u,{options:z,placeholder:"Select frameworks...",value:t,onChange:a}),e.jsxs("p",{className:"text-sm text-muted-foreground",children:["Selected values: ",t.length>0?t.join(", "):"none"]})]})};I.__docgenInfo={description:"",methods:[],displayName:"MultiSelectDefault"};const F=[{value:"react",label:"React"},{value:"vue",label:"Vue"},{value:"angular",label:"Angular"},{value:"svelte",label:"Svelte"},{value:"solid",label:"Solid"}],G=()=>{const[t,a]=i.useState(["react","vue"]);return e.jsxs("div",{className:"space-y-4",children:[e.jsx(u,{options:F,placeholder:"Select frameworks...",value:t,onChange:a}),e.jsxs("p",{className:"text-sm text-muted-foreground",children:["Selected values: ",t.length>0?t.join(", "):"none"]})]})};G.__docgenInfo={description:"",methods:[],displayName:"MultiSelectWithSelection"};const T=[{value:"react",label:"React"},{value:"vue",label:"Vue"},{value:"angular",label:"Angular"},{value:"svelte",label:"Svelte"},{value:"solid",label:"Solid"}],$=()=>{const[t,a]=i.useState([]);return e.jsxs("div",{className:"space-y-4",children:[e.jsx(u,{emptyMessage:"No frameworks found",options:T,placeholder:"Choose your frameworks",searchPlaceholder:"Search frameworks...",value:t,onChange:a}),e.jsxs("p",{className:"text-sm text-muted-foreground",children:["Selected values: ",t.length>0?t.join(", "):"none"]})]})};$.__docgenInfo={description:"",methods:[],displayName:"MultiSelectCustomPlaceholders"};const U=[{value:"react",label:"React"},{value:"vue",label:"Vue"},{value:"angular",label:"Angular"},{value:"svelte",label:"Svelte"},{value:"solid",label:"Solid"},{value:"next",label:"Next.js"},{value:"nuxt",label:"Nuxt.js"},{value:"gatsby",label:"Gatsby"},{value:"remix",label:"Remix"},{value:"astro",label:"Astro"}],E=()=>{const[t,a]=i.useState([]);return e.jsxs("div",{className:"space-y-4",children:[e.jsx(u,{options:U,placeholder:"Select frameworks...",value:t,onChange:a}),e.jsxs("p",{className:"text-sm text-muted-foreground",children:["Selected values: ",t.length>0?t.join(", "):"none"]})]})};E.__docgenInfo={description:"",methods:[],displayName:"MultiSelectWithManyOptions"};const q=`import { useState } from 'react';
