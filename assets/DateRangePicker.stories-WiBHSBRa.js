import{j as t}from"./jsx-runtime-BO8uF4Og.js";import{r as V}from"./index-D4H_InIO.js";import{c as f}from"./utils-l21BANrb.js";import{g as Z}from"./z-index-CmEG1ohp.js";import{B as U}from"./Button-YgMv2nag.js";import{P as $,a as A,b as G}from"./Popover-hyTCyids.js";import{C as H,f as l,a as J,b as K}from"./Calendar-DiqQMQy6.js";import"./useAriaDisabled-DHTVgRPt.js";import"./index-CZyo9ktw.js";import"./index-D8GmRN1t.js";import"./constants-BFjZK9t2.js";import"./styles-hHSuIYOZ.js";import"./index-DKzzznqW.js";import"./index-DwviEg3j.js";import"./index-DXGtwV5R.js";import"./index-C1hSi-0V.js";import"./index-bUn38NNn.js";import"./index-vYCkCKEW.js";import"./index-DAnQV6hb.js";import"./index-Dg2NYmXS.js";import"./index-DsCZslo7.js";import"./index-CHmAJ0Sv.js";import"./floating-ui.react-dom-Cto5zZXc.js";import"./index-C6Lf2F3X.js";import"./index-CIFsUU6l.js";import"./createLucideIcon-CRH11QI6.js";import"./chevron-right-BRUXFm_s.js";const c=V.forwardRef(({value:e,onChange:a,placeholder:o={from:"Pick start date",to:"Pick end date"},className:p,zIndex:W,isDisabled:_=!1,...z},F)=>{const O=Z("popover",W),B=r=>{const{from:n,to:M}=e;if(!n)return a({from:r,to:void 0});if(r<n)return a({from:r,to:void 0});if(n&&M)return a({from:r,to:void 0});if(r>n)return a({from:n,to:r});if(r.getTime()===n.getTime())return a({from:void 0,to:void 0})};return t.jsx("div",{className:f("grid gap-2",p),children:t.jsxs($,{children:[t.jsx(A,{asChild:!0,children:t.jsxs(U,{ref:F,id:"date",variant:"input",className:f("w-full justify-start px-3 text-left font-normal",!e.from&&!e.to&&"text-muted-foreground"),isDisabled:_,...z,"data-component":"date-range-picker",children:[t.jsx(H,{className:"mr-2 h-4 w-4"}),e.from?e.to?t.jsxs(t.Fragment,{children:[l(e.from,"LLLL dd, y")," - ",l(e.to,"LLLL dd, y")]}):l(e.from,"LLLL dd, y"):t.jsx("span",{children:o.from})]})}),t.jsx(G,{className:"w-auto px-0 py-0",align:"start",zIndex:O,children:t.jsx(J,{autoFocus:!0,mode:"range",defaultMonth:e.from,selected:{from:e.from,to:e.to},onSelect:r=>{r&&a(r)},showOutsideDays:!1,onDayClick:B,numberOfMonths:2,modifiers:{today:()=>!1}})})]})})});c.displayName="DateRangePicker";c.__docgenInfo={description:"",methods:[],displayName:"DateRangePicker",props:{value:{required:!0,tsType:{name:"DateRange"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(range: DateRange) => void",signature:{arguments:[{type:{name:"DateRange"},name:"range"}],return:{name:"void"}}},description:""},placeholder:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  from?: string;
  to?: string;
